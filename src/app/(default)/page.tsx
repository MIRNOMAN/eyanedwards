    ...
    <div className="">
      ...
      <ReuseComponent 
        ...
        <div className="md:text-left px-7 md:px-0 text-center mt-[30px]">
          <div className="md:text-[50px] text-base text-[#AA7C38] font-minion font-bold md:leading-[55px]">Funding Options: Simplify Choice</div>
          ...
          <h1 className="md:text-[22px] text-[14px]  text-[#4C4C4C]  font-semibold font-montserrat leading-7">Long term, Low Interest Small Business Loans: <span className="md:font-medium font-normal font-montserrat md:text-[16px] text-[14px]">Up to $3M in Funding for entrepreneurs
          seeking to expand, hire staff, market or buy equipment for their business.</span></h1>
          </div>
          <div className="flex justify-start items-center gap-8 ">
          <Image src={about_icon} width={500} height={500} alt="Your Image"  className="md:h-[28px] h-[20px] md:w-[35px] w-[25px]"/>
          <h1 className="md:text-[22px] text-[14px]  text-[#4C4C4C] font-montserrat font-semibold leading-7">Personal Funding: <span className="md:font-medium font-normal md:text-[16px] font-montserrat text-[14px]">Up to $600K in Funding for individuals, or entrepreneurs, who do not yet
              qualify for traditional business funding or have goals like home renovation, education, or
              personal investments.</span></h1>
          </div>
          <div className="flex justify-start items-center gap-8">
          <Image src={about_icon} width={500} height={500} alt="Your Image"  className="md:h-[28px] h-[20px] md:w-[35px] w-[25px]"/>
          <h1 className="md:text-[22px] text-[14px]  text-[#4C4C4C] font-montserrat font-semibold leading-7">No Doc Funding:  <span className="md:font-medium font-normal md:text-[16px] font-montserrat text-[14px]">Up to $200K in funding for individuals that do not have proof of income.</span></h1>
          </div>
          <div className="flex justify-start items-center gap-8">
          <Image src={about_icon} width={500} height={500} alt="Your Image"  className="md:h-[28px] h-[20px] md:w-[35px] w-[25px]"/>
          <h1 className="md:text-[22px] text-[14px]  text-[#4C4C4C] font-montserrat font-semibold leading-7">Home Equity Lines of Credit: <span className="md:font-medium font-normal md:text-[16px] font-montserrat text-[14px]">Up to $4M in funding for individuals who own Real
          Estate.</span></h1>
          </div>
          </div>
        </div>
