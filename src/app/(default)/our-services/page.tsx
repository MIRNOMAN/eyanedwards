...
export default function page() {
  return (
    <div>
        <Banner
         subtitle={
          <span className="flex justify-center px-[470px]">
...
businesses and individuals secure the funding they
 need no experience Needed!
        ...
        <div className="md:text-left  px-7 md:px-0 text-center mt-[30px]">
          <div className="md:text-[40px] text-base font-semibold font-minion text-[#AA7C38] md:leading-[55px]">Why Partner with Us?</div>

          <div className="md:mt-[47px] space-y-[34px] md:space-y-[64px]">
          <div className="flex justify-start  gap-8">
          <Image src={about_icon} width={500} height={500} alt="Your Image"  className="md:h-[28px] h-[20px] md:w-[35px] w-[25px]"/>
          <h1 className="md:text-[22px] text-[14px]  font-montserrat text-[#4C4C4C]  font-semibold leading-7">Unlimited Product Suite: <span className="md:font-medium font-normal md:text-[16px] text-[14px]">We offer nearly 10 funding
          ...
          <Image src={about_icon} width={500} height={500} alt="Your Image"  className="md:h-[28px] h-[20px] md:w-[35px] w-[25px]"/>
          <h1 className="md:text-[22px] text-[14px] font-montserrat  text-[#4C4C4C]  font-semibold leading-7">Proven Success: <span className="md:font-medium font-normal md:text-[16px] text-[14px]"> From expert coaching to
              cutting-edge AI tools, we’ve got your back every step of
              the way.</span></h1>
          </div>
          <div className="flex justify-start items-center gap-8">
          <Image src={about_icon} width={500} height={500} alt="Your Image"  className="md:h-[28px] h-[20px] md:w-[35px] w-[25px]"/>
          <h1 className="md:text-[22px] text-[14px]  text-[#4C4C4C] font-montserrat  font-semibold leading-7">Unmatched Support:    <span className="md:font-medium font-normal md:text-[16px] text-[14px]">From expert coaching to
          cutting-edge AI tools, we’ve got your back every step of
          the way.</span></h1>
          </div>
          <div className="flex justify-start items-center gap-8">
          <Image src={about_icon} width={500} height={500} alt="Your Image"  className="md:h-[28px] h-[20px] md:w-[35px] w-[25px]"/>
          <h1 className="md:text-[22px] text-[14px]  text-[#4C4C4C]  font-semibold font-montserrat leading-7">Unlimited Potential:   <span className="md:font-medium font-normal md:text-[16px] text-[14px]">Leverage our white-label solutions to
      ...
      <WhatYouGet/>
      <NoExperience/>
      <Card src={pictureSection} alt="Description of the image" className="md:h-full md:w-[70%] px-6 md:px-0" />
      <DifferentSection/>
      <CustomExperience/>
      ...
      <ReuseComponent 
        ...
        <div className="md:text-left md:mt-[171px] mt-[71px] mx-auto px-6 md:px-0  text-center ">
          <div className="md:text-[50px] text-[30px]  text-base font-bold text-primary font-minion md:leading-[55px]">Get Started Today</div>

                <h1 className='mt-[55px] text-[20px] leading-7 font-montserrat font-medium tracking-wide'>Seats Are Limited. Take the first step towards building
