...
import LaserFundBanner from "@/components/GroupEconomics/LaserFundBanner";
...
export default function page() {
  return (
    <div>
        ...
        rightContent={
          <div className="md:text-left mx-auto md:p-10 md:mr-28 md:px-0 px-6 md:mt-28 mt-10 text-center">
            <Image
              ...
              height={500}
              alt="Financial Growth"
              className="[50px] w-[320px]"
            />
            <p className="md:text-[16px] text-base font-montserrat font-normal md:py-[30px] py-5 tracking-wide md:leading-[29px]">
              ...
              financial growth, protecting capital, and achieving sustainable
              returns through transparent and disciplined risk management
              strategies
            </p>
          </div>
        }
      ...
      <ReuseComponent
        ...
        rightContent={
          <div className="md:text-left mx-auto md:p-10 md:mr-18 md:px-0 px-6  mt-10 text-center">
            <h1 className="font-minion md:text-[50px] text-[30px] font-bold text-[#AA7C38] md:leading-[66px]">
              Why We Choose Regulated Brokers
            </h1>
            <p className="md:text-[16px] text-[14px] text-base mt-7 md:mt-0 font-montserrat font-normal md:py-[30px] tracking-wide md:leading-[29px]">
            ...
            <p className="md:text-[16px] text-[14px] mt-7 md:mt-0 text-base font-montserrat font-normal md:py-[30px] tracking-wide md:leading-[29px]">
              At the LASER FUND PAMM, we believe our participants&apos; cash
              safety begins with the brokers we partner with. This is why we
              partner exclusively with regulated brokers: institutions that
              operate under the strict oversight of financial authorities,
              ensuring fairness, transparency, and accountability in every
              transaction.
            </p>
          </div>
        }
      ...
      <Card
        src={what_make_different}
        alt="Meet The Team"
        className="md:h-full md:w-[750px] w-[90%] px-6 md:px-0"
      />
      ...
      <Card
        src={historical}
        alt="Meet The Team"
        className="md:h-full md:w-[750px] px-6 md:px-0 bg-cover"
      />
      <Card
        src={ssPicture1}
        alt="Meet The Team"
        className="md:h-full md:w-full px-6 md:px-0 bg-cover bg-inherit"
      />
      <Card
        src={ssPicture2}
        alt="Meet The Team"
