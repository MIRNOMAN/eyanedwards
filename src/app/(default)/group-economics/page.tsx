...
export default function page() {
  return (
    <div>
         <Banner
                subtitle={
                  <span className="flex justify-center md:px-[450px]">
      ...
      <ReuseComponent 
                  ...
                  rightContent={
                    <div className="md:text-left mx-auto md:p-10 md:mr-18 md:px-0 px-6  mt-10 text-center">
                      <h1 className='font-minion md:text-[50px] text-[30px] font-bold text-[#AA7C38] md:leading-[66px]'>Why We Choose Regulated Brokers</h1>
                ...
                />   
                 ...
                 <Card src={what_make_different} alt="Meet The Team" className="md:h-full md:w-[750px] w-[90%] px-6 md:px-0" /> 
