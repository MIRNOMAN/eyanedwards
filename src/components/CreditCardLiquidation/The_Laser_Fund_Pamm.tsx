...
export default function The_Laser_Fund_Pamm() {
  return (
    ...
    <div className="relative  text-center md:py-[150px] p-6 md:p-0 z-[1] bg-black" >
      ...
      <h2 className="text-3xl md:text-[50px] font-bold mt-[30px] md:leading-[55px] font-minion text-yellow-500">The Laser Fund Pamm</h2>
      
      <p className="text-lg text-center mt-[25px] md:text-[16px] font-montserrat font-normal md:px-[570px] leading-[29px] tracking-widest">
